...
const rejected = validApplications.filter(a=> a.status === 'rejected').length
const pending = validApplications.filter(a=> a.status === 'pending').length
...
<div className='flex gap-4 mb-8'>
    ...
    <Link to='/developer/profile' className='bg-white text-blue-600 px-4 py-2 rounded border border-blue-600 hover:bg-blue-50'>
    Edit Profile
    </Link>
</div>
...
{validApplications.length === 0 ? (
  <div className='bg-white rounded-lg shadow p-6 text-center'>
    <p className='text-gray-500 mb-3'>No job applications available!</p>
